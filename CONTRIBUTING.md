...
This outlines how to propose a change to restrictedROC. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ggrlab/restrictedROC", fork = TRUE)`.
...
- Disable pre-commit for a single commit:
...
[Contributor Code of
Conduct](https://ggrlab.github.io/restrictedROC/CODE_OF_CONDUCT.md). By
...
WARNING!!! If an error occurs because e.g. the repository exists already
at github, use the following instead of `usethis::use_github()`:
