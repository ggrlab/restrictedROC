...
a <- curatedMetagenomicData::curatedMetagenomicData("FrankelAE_2017", dryrun = FALSE, counts = TRUE, rownames = "long")
b <- curatedMetagenomicData::curatedMetagenomicData("WindTT_2020", dryrun = FALSE, counts = FALSE, rownames = "long")
...
for (subcohort_XX in rownames(table_lsubcohort_pfs)) {
    ...
    for (n_permutations in c(1e3, 25e3, 1e5)) {
        rroc_permutation_many_features(
            x = SummarizedExperiment::assay(data_pfs_part),
            response = pheno_pfs_part[["PFS12"]],
            save_intermediate_file = paste0("intermediate_data/lee2022_pfs_rroc_", n_permutations, ".rds"),
