...
print(
    ggplot(bound_taxas, aes(x = pval.twoside.global, y = pval.twoside.max, col = taxonomy)) +
        geom_point() +
...
print(
    ggplot(bound_taxas, aes(x = qval.twoside.global, y = qval.twoside.max, col = taxonomy)) +
        geom_point() +
        geom_vline(xintercept = pval_cutoff, linetype = "dashed") +
        geom_hline(yintercept = pval_cutoff, linetype = "dashed") +
        scale_x_log10() +
...
print(
    ggplot(bound_taxas, aes(x = qval.twoside.global, y = qval.twoside.max)) +
        geom_point() +
        geom_vline(xintercept = pval_cutoff, linetype = "dashed") +
        geom_hline(yintercept = pval_cutoff, linetype = "dashed") +
        scale_x_log10() +
